...
import vertexShader from "../shaders/grain.vert?raw";
import fragmentShader from "../shaders/grain.frag?raw";
import Sphere from "./sphere";
import { degToRad, lerp, randFloat } from "three/src/math/MathUtils";
import Cylinder from "./cylinder";
import { GUI } from "dat.gui";
import greyGradientImg from "../models/img/grey-gradient.png?raw";
...
export default class Scene {
  ...
  setScene() {
    ...
    this.scene.background = new THREE.TextureLoader().load(greyGradientImg);
  }
  ...
  setModel() {
    ...
    // console.log(deer);
    objLoader.load("/resources/labs/01/models/deer.obj", (obj) => {
      console.log(obj);
