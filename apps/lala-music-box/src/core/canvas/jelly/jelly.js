  ...
  "./jelly.js"(exports, module) {
    (function (root, factory) {
      ...
      Jelly.prototype = {
        ...
        initOptions: function (options) {
          ...
          function calcPoints(o, i) {
            extend(o, {
              ...
              centroid: is.str(o.centroid)
                ? document.querySelector(o.centroid)
                : o.centroid
            });
            that.o[i] = extend(o, {
              centroidPoint: that.getCentroid(o.pointsData)
            });
        ...
        initJelly: function () {
          var that = this;
          imageCountDown = createCountDown(function () {
            that.d.resolve();
            that.renderJelly();
          });
        ...
        fadeOut: function (options) {
          var o = extend({ i: 0 }, options);
          var add = 0.02;
          var index = o.i === 0 ? this.o.length - 1 : o.i - 1;
          var alpha = this.o[index].alpha;
          var animation = setInterval(() => {
            alpha -= add;
            this.o[index].alpha = alpha;
            if (alpha <= 0.01) {
              this.o[index].alpha = 0;
        ...
        animateShow: function (point, o) {
          ...
          if (o.animate) {
            ...
            point.ox = point.x =
              point.oldX !== undefined ? point.oldX : point.ox;
            point.oy = point.y =
              point.oldY !== undefined ? point.oldY : point.oy;
          }
        },

        getPointsData: function (o) {
          var paths = is.str(o.paths)
            ? o.pathsContainer.querySelectorAll(o.paths)
            : o.paths;
          var pointsData = [];
        ...
        calcLoop: function (p, o) {
          ...
          for (n = 0; n < len; n++) {
            ...
            var incidence = Math.min(
              o.mouseIncidence * this.speed,
              o.maxIncidence
            );
            if (dist < incidence) {
        ...
        renderJelly: function () {
          ...
          for (i = 0; i < this.o.length; i++) {
            ...
            for (j = 0; j < o.pointsData.length; j++) {
              ...
              this.ctx.clip();
              if (o.image) {
                width = o.imageWidth ? o.imageWidth : o.image.width;
                height = o.imageHeight ? o.imageHeight : o.image.height;
...
// dep:jelly_js
var jelly_js_default = require_jelly();
export { jelly_js_default as default };
