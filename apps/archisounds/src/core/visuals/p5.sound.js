...
(function (root, factory) {
    ...
    */
    (function () {
      ...
      if (
        ...
        if (
          typeof AudioContext.prototype.createPeriodicWave !== 'function'
        )
  ...
  (function (root, factory) {
    ...
    function bindTapListener(element, tapListeners, context) {
      if (
        ...
        (NodeList && element instanceof NodeList)
      ) {
    ...
    function StartAudioContext(context, elements, callback) {
      ...
      promise.then(function () {
        for (var i = 0; i < tapListeners.length; i += 1) {
  ...
  Tone_core_Tone = (function () {
    ...
    Tone.prototype.set = function (params, value, rampTime) {
      ...
      paramLoop: for (var attr in params) {
        ...
        if (attr.indexOf('.') !== -1) {
          ...
          for (var i = 0; i < attrSplit.length - 1; i += 1) {
    ...
    Tone.prototype._collectDefaults = function (constr) {
      ...
      if (!this.isUndef(constr._super)) {
        ...
        for (var i = 0; i < superDefs.length; i += 1) {
  ...
  Tone_core_Emitter = (function (Tone) {
    ...
    Tone.Emitter.prototype.emit = function (event) {
      if (this._events) {
        ...
        if (this._events.hasOwnProperty(event)) {
          var eventList = this._events[event];
          for (var i = 0, len = eventList.length; i < len; i += 1) {
  ...
  helpers = (function () {
    ...
    p5.prototype.soundFormats = function () {
      ...
      for (var i = 0; i < arguments.length; i += 1) {
        ...
        if (
          ['mp3', 'wav', 'ogg', 'm4a', 'aac'].indexOf(arguments[i]) > -1
        ) {
    ...
    p5.prototype.disposeSound = function () {
      for (var i = 0; i < p5sound.soundArray.length; i += 1) {
      ...
      if (typeof paths === 'string') {
        ...
        if (['mp3', 'wav', 'ogg', 'm4a', 'aac'].indexOf(extTest) > -1) {
          if (p5.prototype.isFileSupported(extTest)) {
            ...
            for (var i = 0; i < p5sound.extensions.length; i += 1) {
              ...
              if (supported) {
                ...
                for (var i = 1; i <= pathSplit.length - 2; i += 1) {
                  var p = pathSplit[i];
                  pathCore += '.' + p;
                }
                path = pathCore += '.';
  ...
  soundfile = (function () {
    ...
    p5.SoundFile.prototype.playMode = function (str) {
      ...
      if (s === 'restart' && this.buffer && this.bufferSourceNode) {
        for (var i = 0; i < this.bufferSourceNodes.length - 1; i += 1) {
          var now = p5sound.audiocontext.currentTime;
    ...
    p5.SoundFile.prototype._initCounterNode = function () {
      ...
      if (self._scopeNode) {
        ...
        self._scopeNode.removeEventListener(
          'audioprocess',
          self._onAudioProcess,
        );
      ...
      self._scopeNode.addEventListener(
        'audioprocess',
        self._onAudioProcess,
      );
      return cNode;
    ...
    function getPeaksAtTopTempo(peaksObj, tempo, sampleRate, bpmVariance) {
      ...
      for (var i = 0; i < peaksArray.length; i += 1) {
  ...
  fft = (function () {
    ...
    p5.FFT.prototype.getEnergy = function (frequency1, frequency2) {
      ...
      if (typeof frequency1 !== 'number') {
        ...
        for (var i = lowIndex; i <= highIndex; i += 1) {
    ...
    p5.FFT.prototype.getCentroid = function () {
      ...
      for (var i = 0; i < this.freqDomain.length; i += 1) {
  ...
  Tone_signal_WaveShaper = (function (Tone) {
    ...
    Tone.WaveShaper.prototype.setMap = function (mapping) {
      for (var i = 0, len = this._curve.length; i < len; i += 1) {
  ...
  Tone_type_Time = (function (Tone) {
    ...
    Tone.Time.prototype._toNotationHelper = function (
      ...
      var retNotation = '';
      for (var i = 0; i < testNotations.length; i += 1) {
    ...
    Tone.Time.prototype._notationToUnits = function (notation) {
      ...
      for (var i = 0; i < notationExprs.length; i += 1) {
  ...
  Tone_core_Timeline = (function (Tone) {
    ...
    Tone.Timeline.prototype._search = function (time) {
      ...
      while (beginning < end) {
        ...
        if (event.time === time) {
          for (var i = midPoint; i < this._timeline.length; i += 1) {
  ...
  Tone_signal_TimelineSignal = (function (Tone) {
    ...
    Tone.TimelineSignal.prototype.exponentialRampToValueBetween =
      function (value, start, finish) {
        this.setRampPoint(start);
  ...
  envelope = (function () {
     ...
     *  </code></div>
     */
    p5.Envelope.prototype.setADSR = function (
      aTime,
      dTime,
      sPercent,
      rTime,
     ...
     *  </code></div>
     */
    p5.Envelope.prototype.triggerRelease = function (
      unit,
      secondsFromNow,
    ) {
    ...
    p5.Envelope.prototype.dispose = function () {
      ...
      for (var i = 1; i < this.mathOps.length; i += 1) {
  ...
  pulse = (function () {
    ...
    function createDCOffset() {
      ...
      for (var i = 0; i < 2048; i += 1) data[i] = 1;
  ...
  Tone_signal_Expr = (function (Tone) {
    ...
    Tone.Expr.prototype._parseTree = function (expr) {
      ...
      function matchSyntax(token, syn) {
        return (
          !isUndef(token) && token.type === 'glue' && token.value === syn
        );
      }
    ...
    Tone.Expr.prototype._disposeNodes = function () {
      for (var i = 0; i < this._nodes.length; i += 1) {
  ...
  eq = (function () {
     ...
     * function mouseClicked() {
     *   for (var i = 0; i < eq.bands.length; i += 1) {
     *     eq.bands[i].gain(0);
     *   }
  ...
  soundloop = (function () {
     ...
     */
    p5.SoundLoop.prototype.syncedStart = function (
      otherLoop,
      timeFromNow,
    ) {
      var t = timeFromNow || 0;
  ...
  polysynth = (function () {
    ...
    p5.PolySynth.prototype._allocateVoices = function () {
      for (var i = 0; i < this.maxVoices; i += 1) {
